...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border sm:text-sm px-2 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-0 dark:border-slate-800 dark:focus:ring-slate-300 w-max",
  {
    variants: {
      variant: {
